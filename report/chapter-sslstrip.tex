...
Ainsi, si la requête du client est une simple requête HTTP, l'attaquant va pouvoir lire en clair ce qu'il envoit, et mieux encore, il va également voir la réponse du serveur.
