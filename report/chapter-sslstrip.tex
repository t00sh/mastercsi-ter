...
\begin{figure}[H]
  \caption{La même page HTML, où l'attaquant a strippé un 's'}
...
Le code du proxy est dans le fichier sslstrip.py.
...
La transformation se fait à l'aide d'une expression régulière qui remplace https:// par http:// dans les données HTTP.
