...
Pour firefox par exemple, cette correspondance domaine/empreinte est stockée également dans le fichier \path{~/.mozilla/firefox/XXXX/SiteSecurityServiceState.txt} sur un système Linux.
